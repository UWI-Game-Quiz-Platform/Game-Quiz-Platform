(function( $ ) {
	...
	$(document).ready(function (){
		...
		if( jQuery( 'body' ).hasClass( 'wp-customizer' ) ) {
			...
			$('body.wp-customizer [id*="shuttle_customizer_section_themeoptions"] > h3').click(function(e){ 
				// Code to target title click event in theme options area
			});

			// Remove width classes
			$( 'body.wp-customizer [id*="shuttle_customizer_section_themeoptions"] .accordion-section > button' ).click(function(e){ 
