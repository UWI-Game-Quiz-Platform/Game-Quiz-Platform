...
function shuttle_toolbox_setup() {
	...
	*/
	...
	$config = array(
		...
		'page_start' => array(
			'first' => array (
				...
				'button_link'         => esc_url( 'https://shuttlethemes.com/features/' ),
				'is_button'           => false,
		...
		'page_support'      => array(
			...
			'third' => array(
				...
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', strtolower( $theme_name ) ), ucfirst( $theme_name ) ),
				'button_link'  => 'https://shuttlethemes.com/features/',
				'is_button'    => true,
				'is_new_tab'   => true,
			),
		),
		...
		'page_free_pro'                => array(
			...
			'pro_theme_link'      => 'https://shuttlethemes.com/features/',
			...
			'features'            => array(
				...
				array(
					'title'            => __( 'ShuttleSlider', strtolower( $theme_name ) ),
					'description'      => '',
					'is_in_lite'       => 'false',
					'is_in_lite_text'  => '',
					'is_in_pro'        => 'true',
	...
	shuttle_toolbox_section::init( $config );

}

add_action('after_setup_theme', 'shuttle_toolbox_setup');
